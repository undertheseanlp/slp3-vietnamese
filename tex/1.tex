...
Ví dụ, trong bài toán xác định một từ có đúng chính tả hay không, các bộ phân lớp như cây quyết định, support vector machines, Gaussian Mixture Models, và logistic regression
